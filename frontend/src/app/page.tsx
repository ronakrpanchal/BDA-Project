...
const HowItWroks = () => {
  const content = [
    ...
    {
      id: 3,
      title: "Chat with our bot for suggestions",
      description: "this is random text",
    },
  ];
  return (
    <div className="wrapper flex flex-col justify-center items-center mt-20 md:mt-30 space-y-5 relative px-4 md:px-6">
      ...
      <p className="text-gray-400 text-center">
        A simple three step process to your diet organised
      </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg font-medium">PMD</span>
            </div>
